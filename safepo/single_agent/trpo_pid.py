...
def main(args, cfg_env=None):
    ...
    for epoch in range(epochs):
        ...
        if args.use_shapo_actor:
            ...
            x = conjugate_gradients(fvp, policy, fvp_obs, -sam_grads, CONJUGATE_GRADIENT_ITERS)
        ...
        if args.use_shapo_actor and cos_sim is not None and effective_rho is not None and scale_along_grad is not None:
            logger.store(
                **{
