...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--use-shapo-actor", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Whether to use SAM for actor update"},
        ...
        {"name": "--use-shapo-actor-reward", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Whether to use SAM for actor reward update"},
        {"name": "--use-shapo-actor-cost", "type": lambda x: bool(strtobool(x)), "default": False, "help": "Whether to use SAM for actor cost update"},
